...
export default function Hero({ children, heroImage, isOverlay = false }: Prop) {
    ...
    return (
        <div className="flex flex-col items-center justify-center space-y-12">
            <div className="bg-cover bg-center relative w-full h-400 md:h-400" style={{ backgroundImage: heroImage }}>
                <div className="container mx-auto min-h-400 md:min-h-400 flex items-center flex-col justify-around">

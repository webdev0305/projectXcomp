            ...
            <div className="container">
                <div className="flex flex-wrap justify-around">
                    ...
                    <div className="w-full md:w-1/4 px-4 relative">
                        ...
                        <span>1.</span><small>Step 1</small><img src="https://yiannimize.s3.eu-west-2.amazonaws.com/public/modules/000/020/363/1640190424_jXWQXYgqBA_tap.svg" alt="SELECT YOUR COMPETITION" />
                    ...
                    <div className="w-full md:w-1/4 px-4  relative">
                        <figure className="text-center">
                        <span>2.</span><small>Step 2</small><img src="https://yiannimize.s3.eu-west-2.amazonaws.com/public/modules/000/020/363/1640190424_JraVDsGXID_laptop.svg" alt="LOG IN OR SIGN UP" />
                        <h4>Buy ticket</h4>
                    ...
                    <div className="w-full md:w-1/4 px-4  relative">
                        <figure className="text-center">
                        <span>3.</span><small>Step 3</small><img src="https://yiannimize.s3.eu-west-2.amazonaws.com/public/modules/000/020/363/1640190424_dPUUQfOYdW_ticket.svg" alt="PROCEED TO CHECK OUT" />
                ...
                <div className="flex flex-wrap">
                    <div className="w-full text-center"><a href="/competitions" className="button"><button>ENTER TO PLAY</button></a></div>
                </div>
            </div>
        </div>
            ...
            <div className="container">
                <div className="flex flex-wrap">
                    <div className="w-full">
                        ...
                        <p>If you have any further questions, please email the team at <a href="mailto:hello@yiannimizecomps.com">hello@yiannimizecomps.com</a></p>
                    </div>
                </div>
            </div>
        </div>
